...
# configuration <- visualize_weights_normalized(configuration)
...
# configuration <- visualize_lambdas_with_player(configuration)
# configuration <- visualize_weights(configuration)
# configuration <- visualize_weights_binary(configuration)
# configuration <- visualize_losses_for_sim_analysis_no_crop(configuration)
# configuration <- visualize_data_toggles(configuration)
configuration <- visualize_excess_losses_normals(configuration)
# configuration <- visualize_weights_normals(configuration)
# configuration <- visualize_weights_normalized_normals(configuration)
# configuration <- visualize_data_normals(configuration)
